...
- Migration to operational/canonical requires formal reclassification

## Authority Chain
- **Experimental tier** - No upstream canonical authority required
- Changes reviewed by: hummbl-dev contributors
- Promotion path: experimental → operational → canonical (if stabilized)
